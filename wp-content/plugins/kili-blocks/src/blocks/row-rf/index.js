...
const processStyles = function(props) {
  ...
  if (props.attributes.paddingTopMobile) {
    styles +=
      ...
      "padding-top:" +
      props.attributes.paddingTopMobile +
      "px;";
  }
  if (props.attributes.paddingBottomMobile) {
    styles +=
      (styles !== "" ? "" : customClassName + "{") +
      "padding-bottom:" +
      props.attributes.paddingBottomMobile +
      "px;";
  }
  if (props.attributes.marginTopMobile) {
    styles +=
      (styles !== "" ? "" : customClassName + "{") +
      "margin-top:" +
      props.attributes.marginTopMobile +
      "px;";
  }
  if (props.attributes.marginBottomMobile) {
    styles +=
      (styles !== "" ? "" : customClassName + "{") +
      "margin-bottom:" +
      props.attributes.marginBottomMobile +
      "px;";
  }
  if (styles !== "") {
    styles += "}";
  ...
  if (
    props.attributes.paddingBottomDesktop ||
